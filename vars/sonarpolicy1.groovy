...
String response = sh(script:"""curl --location --request POST 'http://18.224.228.236:8181/v1/data/sonar/policy/gate' --header 'Content-Type: application/json' --data-raw '{ "input": { "user": "ramya", "qualitygate": "50"} }'""" , returnStdout: true)
println(response)
