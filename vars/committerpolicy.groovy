...
String response = sh(script:"""curl --location --request POST 'http://18.221.205.57:8181/v1/data/play/foo' --header 'Content-Type: application/json' --data-raw '{"committer":[{"name":"'${committername}'","branch_name":"'${branch}'"}]}'""", returnStdout: true)
println(response)
}
