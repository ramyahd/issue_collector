...
String response = sh(script:"""curl --location --request POST 'http://18.221.205.57:8181/v1/data/commit/policy/foo' --header 'Content-Type: application/json' --data-raw '{ "committer" : [{ "branch_name": "master","name": "Alice" }] }'""", returnStdout: true)
println(response)
}
