...
String response = sh(script:"""curl --location --request POST 'http://18.221.205.57:8181/v1/data/metrics/policy/result' --header 'Content-Type: application/json' --data-raw '{"servers": {"branch_name": "master","name": "Alice"}}'"""| jq)
println(response)
