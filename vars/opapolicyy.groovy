...
String response = sh(script:"""curl --location --request POST 'http://18.221.205.57:8181/v1/data/metrics/policy/result' --header 'Content-Type: application/json' --data-raw '{ "input":{"servers": {"branch_name": "master","id": "Alice"}}}'"""  returnStdout: true)
println(response)
