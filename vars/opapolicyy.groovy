...
String response = sh(script:"""curl --location --request POST 'http://18.224.228.236:8181/v1/data/sonarcode/policy' --header 'Content-Type: application/json' --data-raw '{ "input" : {"project": "Wolvorines","branch": "Metrics", "auth" : "rama", "vulnerability": "1","codecoverage":"90"} }'""", returnStdout: true)
println(response)
}
