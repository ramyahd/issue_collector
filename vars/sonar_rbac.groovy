...
String response = sh(script:"""curl --location --request POST 'http://18.221.205.57:8181/v1/data/commit/policy' --header 'Content-Type: application/json' --data-raw '{"input": { "user": "alice","branch": "master", "auth" : "ramya"}}'""", returnStdout: true)
println(response)
